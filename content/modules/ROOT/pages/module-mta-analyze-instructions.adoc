...
First, you need to configure *Git repositories* to refer to your link:{gitea_console_url}/modern-app-dev[Gitea repository^] when you analyze your inventory and applications using MTA.
...
* Repository type - `Git`
* Source Repository - `{gitea_console_url}/modern-app-dev.git`
